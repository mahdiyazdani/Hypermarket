...
Contact form component comes with built in **honey pot** trap which is used to create a form with an extra field that is hidden to human visitors but readable by robots.
